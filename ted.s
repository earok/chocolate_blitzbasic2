...
edstart	include	shared/wbheader
	sub.l	a1,a1
	rts
...
sleep	incbin	ted_files/sleep.bin
sleepf

pointer	incbin	ted_files/pointer.bin
pointerf
...
srcinfo	incbin	ted_files/src.info
srcinfof	even

	include	ted_files/aboutreq

	include	ted_files/specialreq
...
newsctit	dc.b	'Blitz Basic 2 - Chocolate TED',0
	ds.b	80
	even
...
menu1item11	dc.l	0 ;No next item
	dc	0,108 ;X/Y
	dc	mwidth,12 ;Width/Height
	dc	2+16+64+4 ;Flags
	dc.l	0,m1i11name,0
	dc.b	'Q ' ;Command
	dc.l	0 ;SubMenu
...
rawed	incbin	ted_files/rawed.obj
...
filerequest	incbin	ted_files/filereq
...
font6	incbin	ted_files/chars.b
font8	incbin	ted_files/chars8.b
